...
get_spe_customizedQC_cell <- function(dir_rawData, cutoff_QC = 20){
  ...
  for(sample_tmp in samples_filderName){
    ...
    df_transcripts_QC20_nuclear = df_transcripts_QC20[df_transcripts_QC20$overlaps_cell ==1  ,]
    fwrite(df_transcripts_QC20_nuclear, file= paste0(dir_tmp,"/",sample_tmp,"_cellLevel_qv/", "transcripts.csv"))
